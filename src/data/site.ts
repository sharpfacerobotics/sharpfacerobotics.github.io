...
export const subsystems = [
  { n: '01', h: 'Drivetrain',       p: 'Evolved from a ladder-drive prototype into a fully integrated mecanum frame — better packaging, more rigidity, easier to service, same omnidirectional control.' },
  { n: '02', h: 'Intake + transfer', p: 'A dual-compliant pitching intake and compact transfer chain, tuned through iteration to absorb approach-angle error and stop jamming under match pressure.' },
  { n: '03', h: 'Shooter',           p: 'Launcher geometry and compression refined across several versions for shot repeatability, shorter spin-up between cycles, and accuracy from distance.' },
  { n: '04', h: 'Localization',      p: 'Limelight AprilTag sensing fused with GoBILDA odometry for field awareness — automatic alignment and distance-aware shooting in both auto and TeleOp.' },
  { n: '05', h: 'Autonomous',        p: 'Pedro Pathing and explicit state machines drive repeatable routes with recovery logic, instead of fragile timing-only routines.' },
  { n: '06', h: 'Driver experience', p: 'Driver-centric mapping and macros keep controls predictable, so operators watch the game while automation handles the timing-sensitive steps.' },
];
